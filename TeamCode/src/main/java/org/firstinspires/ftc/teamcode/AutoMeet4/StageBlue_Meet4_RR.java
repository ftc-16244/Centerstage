...
@Autonomous
public class StageBlue_Meet4_RR extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d StageBlueLeftDropoff = new Pose2d(-40.5, 54, Math.toRadians(90));//backstage
        ...
        Pose2d StageBlueRightDropoff = new Pose2d(-28.5,54.25, Math.toRadians(90));
