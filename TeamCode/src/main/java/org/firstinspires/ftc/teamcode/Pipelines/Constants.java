...
public class Constants {
    ...
    public static final Scalar RED_LOW_HSV = new Scalar(0, 140,  100);
    public static final Scalar RED_HIGH_HSV = new Scalar(25, 255, 255);
    public static final Scalar RED_LOW_HSV2 = new Scalar(160, 140,  100); //other half of the red spectrum
    public static final Scalar RED_HIGH_HSV2 = new Scalar(180, 255, 255);
    public static final Scalar BLUE_LOW_HSV = new Scalar(90, 90, 35);
